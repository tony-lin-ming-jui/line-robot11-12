...
channel_secret = os.getenv('18305b046cb7b77b860f4381569cafd3', None)
channel_access_token = os.getenv('dzMHXFwU0FbiK7Ct+zLK80AgIt3wHV7trwSdsh+EjSKNW8vTir0fhCP6qRsqLWjl/UxiiqECfBK6AfHe0htI/Ksqz0DQLAGBoZZnsLG7lgXlHSvG7gd6yW2LT7K5qbXl4fQ4f3X+YCWlfXPv/vptTwdB04t89/1O/w1cDnyilFU=', None)
...
def handle_text_message(event):
    ...
    if text == 'profile':#獲取讀者資訊
        ...
        buttons_template = ButtonsTemplate(
            title='My buttons sample', text='Hello, my buttons', actions=[
                ...
                PostbackAction(label='ping', data='ping'),#這裡只會點了跳出pong 我要點了直接跳實驗室的東西
    ...
    elif text == 'quick_reply':#快速的button
        line_bot_api.reply_message(
            event.reply_token,
            TextSendMessage(
                text='Quick reply',

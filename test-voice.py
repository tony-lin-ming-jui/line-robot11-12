...
'''
    if a=="基隆天氣":
        ...
        with open('static/texts.m4a', 'wb') as f:
            try:
...
def handle_message(event):
    ...
    if event.message.text == '我是誰':
       ...
       line_bot_api.reply_message(event.reply_token,StickerSendMessage(package_id=sticker[0], sticker_id=sticker[1]))
        ...
        line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/timenow.m4a', duration=100000))
        ...
        mixer.music.play()            
        #line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/oil.m4a', duration=100000))
        line_bot_api.reply_message(event.reply_token,TextSendMessage(text=oil))
    elif event.message.text == "語音油價":
        oil=oil_crawler_n_office.oil()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+oil+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/oil.m4a', 'wb') as f:
        ...
        mixer.music.play()
        line_bot_api.push_message(user_id,ImageSendMessage(original_content_url="https://851423b6.ngrok.io/static/oil.jpg", preview_image_url="https://851423b6.ngrok.io/static/oil.jpg"))
        line_bot_api.reply_message(event.reply_token,TextSendMessage(text=m+u))
        
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/nationoil.m4a', duration=100000))

    elif event.message.text == "語音國際油價":
        #oilof=oil_crawler_of.oilof()
        ...
        #line_bot_api.push_message(user_id,ImageSendMessage(original_content_url="https://851423b6.ngrok.io/static/oil.jpg", preview_image_url="https://851423b6.ngrok.io/static/oil.jpg"))
        #line_bot_api.reply_message(event.reply_token,TextSendMessage(text=m+u))        
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/nationoil.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Keelung.m4a', duration=100000))

    elif event.message.text =="語音基隆天氣":
        weather=weather_data.weather()        
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[0]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Keelung.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Keelung.m4a')
        mixer.music.play()            
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Keelung.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Keelung.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taipei.m4a', duration=100000))
    elif event.message.text =="語音台北天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[1]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Taipei.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Taipei.m4a')
        mixer.music.play() 
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taipei.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taipei.m4a', duration=100000))
        ...
        line_bot_api.reply_message(event.reply_token,TextSendMessage(text=weather[1]))
        line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taipei.m4a', duration=100000))
    elif event.message.text =="語音臺北天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[1]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Taipei.m4a', 'wb') as f:
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/NTaipei.m4a', duration=100000))
    elif event.message.text =="語音新北天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[2]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/NTaipei.m4a', 'wb') as f:
        ...
        mixer.music.load('static/NTaipei.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/NTaipei.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/NTaipei.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/PPK.m4a', duration=100000))
    elif event.message.text =="語音北北基天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[0]+weather[1]+weather[2]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/PPK.m4a', 'wb') as f:
        ...
        mixer.music.load('static/PPK.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/PPK.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/PPK.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taoyuan.m4a', duration=100000))
    elif event.message.text =="語音桃園天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[3]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Taoyuan.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Taoyuan.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taoyuan.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Hsinchu.m4a', duration=100000))
    elif event.message.text =="語音新竹天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[4]+weather[5]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Hsinchu.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Hsinchu.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Hsinchu.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Hsinchu.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Miaoli.m4a', duration=100000))
    elif event.message.text =="語音苗栗天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[6]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Miaoli.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Miaoli.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Miaoli.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/THM.m4a', duration=100000))
    elif event.message.text =="語音桃竹苗天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[3]+weather[4]+weather[5]+weather[6]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/THM.m4a', 'wb') as f:
        ...
        mixer.music.load('static/THM.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/THM.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taichung.m4a', duration=100000))

    elif event.message.text =="語音台中天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[7]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Taichung.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Taichung.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taichung.m4a', duration=100000))
        ...
        line_bot_api.reply_message(event.reply_token,TextSendMessage(text=weather[7]))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taichung.m4a', duration=100000))
    elif event.message.text =="語音臺中天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[7]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Taichung.m4a', 'wb') as f:
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Changhua.m4a', duration=100000))
    elif event.message.text =="語音彰化天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[8]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Changhua.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Changhua.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Changhua.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Changhua.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Nantou.m4a', duration=100000))
    elif event.message.text =="語音南投天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[9]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Nantou.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Nantou.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Nantou.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Nantou.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Yunlin.m4a', duration=100000))
        
    elif event.message.text =="語音雲林天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[10]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Yunlin.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Yunlin.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Yunlin.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Yunlin.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Chiayi.m4a', duration=100000))
    elif event.message.text =="語音嘉義天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[11]+weather[12]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Chiayi.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Chiayi.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Chiayi.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Chiayi.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Yilan.m4a', duration=100000))

    elif event.message.text =="語音宜蘭天氣":
        weather=weather_data.weather()                
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[13]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Yilan.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Yilan.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Yilan.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Yilan.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Hualie.m4a', duration=100000))
    elif event.message.text =="語音花蓮天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[14]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Hualie.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Hualie.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Hualie.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Hualie.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taitung.m4a', duration=100000))        
    elif event.message.text =="語音台東天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[15]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Taitung.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Taitung.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taitung.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Taitung.m4a', duration=100000))
    ...
    elif event.message.text =="語音臺東天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[15]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Taitung.m4a', 'wb') as f:
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Huatung.m4a', duration=100000))
    elif event.message.text =="語音花東天氣":        
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[14]+weather[15]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Huatung.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Huatung.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Huatung.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Huatung.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Tainan.m4a', duration=100000))
    elif event.message.text =="語音台南天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[16]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Tainan.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Tainan.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Tainan.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Tainan.m4a', duration=100000))
        ...
        line_bot_api.reply_message(event.reply_token,TextSendMessage(text=weather[16]))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Tainan.m4a', duration=100000))
    elif event.message.text =="語音臺南天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[16]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Tainan.m4a', 'wb') as f:
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Kaohsiung.m4a', duration=100000))

    elif event.message.text =="語音高雄天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[17]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Kaohsiung.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Kaohsiung.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Kaohsiung.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Kaohsiung.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Pingtung.m4a', duration=100000))
        
    elif event.message.text =="語音屏東天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[18]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Pingtung.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Pingtung.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Pingtung.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Lienchiang.m4a', duration=100000))

    elif event.message.text =="語音連江天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[19]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Lienchiang.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Lienchiang.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Lienchiang.m4a', duration=100000))
        ...
        mixer.music.play()
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Kinmen.m4a', duration=100000))
        line_bot_api.reply_message(event.reply_token,TextSendMessage(text=weather[20]))

    elif event.message.text =="語音金門天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[20]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Kinmen.m4a', 'wb') as f:
        ...
        mixer.music.play()
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Kinmen.m4a', duration=100000))
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Kinmen.m4a', duration=100000))        
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Penghu.m4a', duration=100000))

    elif event.message.text =="語音澎湖天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[21]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/Penghu.m4a', 'wb') as f:
        ...
        mixer.music.load('static/Penghu.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Penghu.m4a', duration=100000))
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/outerisland.m4a', duration=100000))
        
    elif event.message.text =="語音外島天氣":
        weather=weather_data.weather()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+weather[19]+weather[20]+weather[21]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/outerisland.m4a', 'wb') as f:
        ...
        mixer.music.load('static/outerisland.m4a')
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/outerisland.m4a', duration=100000))
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/outerisland.m4a', duration=100000))
        ...
        mixer.music.play()
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/classcancel.m4a', duration=100000))
        line_bot_api.reply_message(event.reply_token,TextSendMessage(text=cancel[0]+"\n"+cancel[1]))

    elif event.message.text =="語音停班停課":
        cancel=work_class_cancel_crawler.wkncls()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+cancel[0]+cancel[1]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/classcancel.m4a', 'wb') as f:
        ...
        mixer.music.play()
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/classcancel.m4a', duration=100000))
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/classcancel.m4a', duration=100000))
        ...
        mes='歡迎使用語音功能 請說 語音縣市天氣 例如 語音台南天氣 語音停班停課'
        ...
        mixer.music.play()
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/Instruction.m4a', duration=100000))
            ...
            template=CarouselTemplate(
                columns=[
                    ...
                    CarouselColumn(
                        thumbnail_image_url='https://i.imgur.com/xOrDUep.jpg',
                        title='歡迎來到404實驗室',                        
                        text='語音PM2.5、語音揮發性有機物、語音甲醛',
                        actions=[
                            PostbackAction(label='語音PM2.5', data='語音PM2.5'),
                            PostbackAction(label='語音揮發性有機物', data='語音揮發性有機物'),
                            PostbackAction(label='語音甲醛', data='語音甲醛')
                        ]
                    ),
                    CarouselColumn(
                        thumbnail_image_url='https://i.imgur.com/xOrDUep.jpg',
                        title='歡迎來到404實驗室',
                        text='語音二氧化碳、語音溫度、語音濕度',
                        actions=[
                            PostbackAction(label='語音二氧化碳', data='語音二氧化碳'),
                            PostbackAction(label='語音溫度', data='語音溫度'),
                            PostbackAction(label='語音相對濕度', data='語音相對濕度')
                        ]
                    )
                ]
            )
...
def handle_postback(event):
    if event.postback.data == 'PM2.5':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[0]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/PM25.m4a', duration=100000))
    elif event.postback.data == '揮發性有機物':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[1]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/TVOC.m4a', duration=100000))
    elif event.postback.data == '甲醛':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[2]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/HCHO.m4a', duration=100000))
    elif event.postback.data == '二氧化碳':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[3]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/CO2.m4a', duration=100000))
    elif event.postback.data == '溫度':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[4]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/tem.m4a', duration=100000))
    elif event.postback.data == '相對濕度':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[5]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        ...
        #line_bot_api.push_message(user_id,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/hum.m4a', duration=100000))
    elif event.postback.data == '語音PM2.5':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[0]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/PM25.m4a', 'wb') as f:
        ...
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/PM25.m4a', duration=100000))
    elif event.postback.data == '語音揮發性有機物':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[1]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/TVOC.m4a', 'wb') as f:
        ...
        mixer.music.play()
        #line_bot_api.reply_message(event.reply_token, TextSendMessage(PTQS[1]))
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/TVOC.m4a', duration=100000))
    elif event.postback.data == '語音甲醛':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[2]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/HCHO.m4a', 'wb') as f:
        ...
        mixer.music.play()
        #line_bot_api.reply_message(event.reply_token, TextSendMessage(PTQS[2]))
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/HCHO.m4a', duration=100000))
    elif event.postback.data == '語音二氧化碳':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[3]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/CO2.m4a', 'wb') as f:
        ...
        mixer.music.play()
        #line_bot_api.reply_message(event.reply_token, TextSendMessage(PTQS[3]))
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/CO2.m4a', duration=100000))
    elif event.postback.data == '語音溫度':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[4]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/tem.m4a', 'wb') as f:
        ...
        mixer.music.play()
        #line_bot_api.reply_message(event.reply_token, TextSendMessage(PTQS[4]))
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/tem.m4a', duration=100000))
    elif event.postback.data == '語音相對濕度':
        PTQS=PTQS1005.ptq()
        stream_url = 'https://google-translate-proxy.herokuapp.com/api/tts?query='+PTQS[5]+'&language=zh-tw'
        r = requests.get(stream_url, stream=True)
        with open('static/hum.m4a', 'wb') as f:
        ...
        mixer.music.play()
        #line_bot_api.reply_message(event.reply_token, TextSendMessage(PTQS[5]))
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://851423b6.ngrok.io/static/hum.m4a', duration=100000))
